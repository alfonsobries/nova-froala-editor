...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return YouTubePlayer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getIdFromURL; });
...
Nova.booting(function (Vue, router) {
    Vue.component('index-youtube', __webpack_require__(5));
    Vue.component('detail-youtube', __webpack_require__(8));
    Vue.component('form-youtube', __webpack_require__(15));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_youtube_embed__ = __webpack_require__(2);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_youtube_embed__["b" /* default */], { global: false });
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['resourceName', 'field'],

    components: {
        'youtube': __WEBPACK_IMPORTED_MODULE_1_vue_youtube_embed__["a" /* YouTubePlayer */]
    },
    ...
    computed: {
        ...
        videoId: function videoId() {
            return Object(__WEBPACK_IMPORTED_MODULE_1_vue_youtube_embed__["c" /* getIdFromURL */])(this.field.value);
        },
        ...
        couldStart: function couldStart() {
            if (this.videoId.length > 1 && this.field.value.indexOf('http') === 0) {
                return !this.play;
            }
            return false;
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm.couldStart
        ? _c("span", { on: { click: _vm.start } }, [_vm._v("▶")])
        : _vm._e(),
      _vm._v(" "),
      _vm.display
        ? _c("span", { on: { click: _vm.stop } }, [_vm._v("✖")])
        : _vm._e(),
      _vm._v(" "),
      _vm.display
        ? _c("youtube", {
